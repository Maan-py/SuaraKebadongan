    ...
    return (
      <div className="min-h-dvh">
        <div className="px-4 py-8 md:px-6">
          <div className="mb-3 h-8 w-40 animate-pulse rounded bg-tinta/10" />
          <div className="h-32 animate-pulse rounded-radius-kartu bg-tinta/5" />
        </div>
        <div className="min-h-dvh px-4 py-8 md:px-6">
          <div className="columns-2 gap-3 sm:columns-3 lg:columns-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="mb-4 break-inside-avoid animate-pulse rounded bg-tinta/5"
