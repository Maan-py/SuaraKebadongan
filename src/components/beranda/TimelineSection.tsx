                ...
                >
                  ...
                  >
                    ...
                    <img 
                      src="/push-pin.png" 
                      alt="Pin" 
                      className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 object-contain drop-shadow-sm z-20 group-hover:scale-110 transition-transform"
                    />
                    ...
                    {item.imgSrc && (
                      <img 
                        src={item.imgSrc}
                        alt="Foto Jurnal"
                        className="w-full bg-karton border border-sepia-terang/20 flex items-center justify-center p-4 text-center transition-transform duration-300 group-hover:scale-[1.02]"
                      />
                    )}
                    
                    {/* Label */}
                    <p className="absolute bottom-2 left-0 right-0 text-center font-tulis text-lg text-tinta group-hover:text-terracotta transition-colors">
                      {item.label}
                    </p>
                  </motion.div>
