      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none rounded-radius-tape border border-terracotta/30 bg-polaroid px-4 py-2.5 font-tulis text-sm text-tinta-gelap placeholder:text-tinta-gelap/50 focus:border-terracotta focus:outline-none"
          ...
          <button
            onClick={handleSend}
            disabled={!canSend}
            className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-terracotta text-polaroid transition-colors hover:bg-terracotta/90 disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div className="mt-1.5 flex justify-between px-1">
          ...
          {charWarning && (
            <span
              className="font-tulis text-[10px] text-terracotta"
              aria-live="polite"
            >
