...
export default function ChatInput({ onMessageSent }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-garis-kertas bg-karton p-3 pb-20 md:pb-3">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="flex items-end gap-2">
          ...
          <button
            onClick={handleSend}
            disabled={!canSend}
            className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-tape-hijau text-polaroid transition-colors hover:bg-tape-hijau/90 disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div className="mt-1.5 flex justify-between px-1">
          <span className="text-[10px] text-tinta-lembut/40">
